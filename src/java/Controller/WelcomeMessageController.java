 ...
 * @author Rasika
 */
@WebServlet(name = "WelcomeMessageController", urlPatterns = {"/greeter"})
public class WelcomeMessageController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String msg = nms.getMessage(nameEntered);        
